!(function(e) {
                ...
                case 'MultiPolygon':
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === w && (M = 0), i = 0; i < u[n].length; i++) {
                      for (s = 0; s < u[n][i].length - d; s++) {
                        if (!1 === t(u[n][i][s], f, _, b, M)) return !1;
                        f++;
                      }
                      M++;
                    }
            ...
            switch (i.type) {
              ...
              case 'GeometryCollection':
                for (o = 0; o < i.geometries.length; o++)
                  if (!1 === t(i.geometries[o], d, u, c, h)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
            ...
            return (
              !1 !==
                o(e, function(o, s, l, c, h) {
                  ...
                  var d = Object(u.e)([a, o], e.properties);
                  if (!1 === t(d, r, n, h, i)) return !1;
                  i++, (a = o);
                }) && void 0
            );
          }
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      initialize: function(e) {
        ...
        var t = this.options,
          r = t.activeColor,
          o = t.completedColor;
        (this._symbols = new f.default({ activeColor: r, completedColor: o })),
      ...
      _getMeasurementDisplayStrings: function(e) {
        ...
        function r(e, t, r, o) {
          ...
          return [
            (0, p.numberFormat)(e * i.factor, i.decimals, r || ',', o || '.'),
  ...
  function(e, t, r) {
    (function(t) {
      ...
      function j(e) {
        return (
          !!C(e) && (re.call(e) == B || ('string' == typeof e.message && 'string' == typeof e.name))
        );
      }
      function k(e) {
        var t = P(e) ? re.call(e) : '';
      ...
      function E(e) {
        return 'symbol' == typeof e || (C(e) && re.call(e) == U);
      }
      function x(e) {
        return null == e ? '' : p(e);
      }
  ...
  function(e, t, r) {
    ...
    function o(e, t, r) {
      ...
      return Object(i.g)(2 * Math.atan2(Math.sqrt(d), Math.sqrt(1 - d)), o);
    }
    var n = r(13),
      i = r(0);
    t.a = o;
