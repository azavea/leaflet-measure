!(function(e) {
  ...
  function(e, t, r) {
    ...
    function n(e, t, r) {
      if (null !== e)
        for (
          ...
          (c = m ? e.features[_].geometry : y ? e.geometry : e),
          ...
          for (var v = 0; v < l; v++) {
            ...
            if (null !== (a = h ? c.geometries[v] : c)) {
              u = a.coordinates;
              var w = a.type;
              switch (((d = !r || ('Polygon' !== w && 'MultiPolygon' !== w) ? 0 : 1), w)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, f, _, b, M)) return !1;
                  f++, b++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (o = 0; o < u.length; o++) {
                    if (!1 === t(u[o], f, _, b, M)) return !1;
                    f++, 'MultiPoint' === w && b++;
                  }
                  'LineString' === w && b++;
                  break;
                ...
                case 'MultiLineString':
                  for (o = 0; o < u.length; o++) {
                    for (i = 0; i < u[o].length - d; i++) {
                      if (!1 === t(u[o][i], f, _, b, M)) return !1;
                      f++;
                    }
                ...
                case 'MultiPolygon':
                  for (o = 0; o < u.length; o++) {
                    for ('MultiPolygon' === w && (M = 0), i = 0; i < u[o].length; i++) {
                      for (s = 0; s < u[o][i].length - d; s++) {
                        if (!1 === t(u[o][i][s], f, _, b, M)) return !1;
                        f++;
                      }
                      M++;
                    }
    ...
    function o(e, t) {
      var r,
        ...
        p = 'Feature' === e.type,
        m = f ? e.features.length : 1;
      for (r = 0; r < m; r++) {
        for (
          a = f ? e.features[r].geometry : p ? e.geometry : e,
            u = f ? e.features[r].properties : p ? e.properties : {},
            c = f ? e.features[r].bbox : p ? e.bbox : void 0,
            h = f ? e.features[r].id : p ? e.id : void 0,
          ...
          if (null !== (i = l ? a.geometries[o] : a))
            switch (i.type) {
              ...
              case 'MultiLineString':
              case 'MultiPolygon':
                if (!1 === t(i, d, u, c, h)) return !1;
                break;
              case 'GeometryCollection':
                for (n = 0; n < i.geometries.length; n++)
                  if (!1 === t(i.geometries[n], d, u, c, h)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
            ...
            return (
              !1 !==
                n(e, function(n, s, l, c, h) {
                  ...
                  var d = Object(u.e)([a, n], e.properties);
                  if (!1 === t(d, r, o, h, i)) return !1;
                  i++, (a = n);
                }) && void 0
            );
          }
  ...
  function(e, t, r) {
    ...
    var o = r(7),
      ...
      p = r(17),
      m = r(18),
      y = { imports: { numberFormat: p.numberFormat }, interpolate: /{{([\s\S]+?)}}/g },
      g = (0, i.default)(m.controlTemplate, y),
      _ = (0, i.default)(m.resultsTemplate, y),
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      initialize: function(e) {
        ...
        var t = this.options,
          r = t.activeColor,
          n = t.completedColor;
        (this._symbols = new f.default({ activeColor: r, completedColor: n })),
    ...
    (function(t) {
      ...
      function l(e, t) {
        var r = ue(e) || M(e) ? i(e.length, String) : [],
          n = r.length,
          o = !!n;
        for (var s in e) (!t && !te.call(e, s)) || (o && ('length' == s || y(s, n))) || r.push(s);
        return r;
      }
      function u(e, t, r, n) {
      ...
      function g(e, t, r) {
        if (!P(r)) return !1;
        var n = typeof t;
        return !!('number' == n ? w(r) && y(t, r.length) : 'string' == n && t in r) && b(r[t], e);
      }
      function _(e) {
      ...
      function M(e) {
        return L(e) && te.call(e, 'callee') && (!oe.call(e, 'callee') || re.call(e) == N);
      }
      function w(e) {
      ...
      function C(e) {
        return 'symbol' == typeof e || (E(e) && re.call(e) == U);
      }
      function x(e) {
        return null == e ? '' : p(e);
      }
      ...
      function D(e) {
        return w(e) ? l(e, !0) : d(e);
      }
      function A(e, t, r) {
        var n = $.imports._.templateSettings || $;
        r && g(e, t, r) && (t = void 0), (e = x(e)), (t = ce({}, t, n, u));
        var o,
          i,
          ...
          y = 'sourceURL' in t ? '//# sourceURL=' + t.sourceURL + '\n' : '';
        e.replace(m, function(t, r, n, s, l, u) {
          return (
            n || (n = s),
            (p += e.slice(d, u).replace(Z, a)),
            r && ((o = !0), (p += "' +\n__e(" + r + ") +\n'")),
            l && ((i = !0), (p += "';\n" + l + ";\n__p += '")),
            n && (p += "' +\n((__t = (" + n + ")) == null ? '' : __t) +\n'"),
            (d = u + t.length),
        ...
        _ || (p = 'with (obj) {\n' + p + '\n}\n'),
          ...
          (p =
            ...
            'return __p\n}');
        var v = he(function() {
          return Function(c, y + 'return ' + p).apply(void 0, h);
        });
          ...
          return f(function(t, r) {
            ...
            for (
              i = e.length > 3 && 'function' == typeof i ? (o--, i) : void 0,
                s && g(r[0], r[1], s) && ((i = o < 3 ? void 0 : i), (o = 1)),
                t = Object(t);
              ++n < o;
  ...
  function(e, t, r) {
    (function(t) {
      ...
      function a(e) {
        return (e = s(e)), e && d.test(e) ? e.replace(h, v) : e;
      }
      var l = r(2),
        u = 1 / 0,
        c = '[object Symbol]',
        ...
        k = { escape: f, evaluate: p, interpolate: l, variable: '', imports: { _: { escape: a } } };
      e.exports = k;
    }.call(t, r(1)));
  },
  function(e, t, r) {
  ...
  function(e, t, r) {
    ...
    function n(e, t, r) {
      ...
      return Object(i.g)(2 * Math.atan2(Math.sqrt(d), Math.sqrt(1 - d)), n);
    }
    var o = r(13),
      i = r(0);
    t.a = n;
