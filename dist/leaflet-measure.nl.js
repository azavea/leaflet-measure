  ...
  function(e, t, r) {
    (function(t) {
      ...
      function y(e, t, r) {
        if (!P(r)) return !1;
        var n = typeof t;
        return !!('number' == n ? w(r) && g(t, r.length) : 'string' == n && t in r) && b(r[t], e);
      }
      function v(e) {
      ...
      function M(e) {
        return L(e) && te.call(e, 'callee') && (!oe.call(e, 'callee') || re.call(e) == F);
      }
      function w(e) {
      ...
      function k(e) {
        return (
          !!C(e) && (re.call(e) == N || ('string' == typeof e.message && 'string' == typeof e.name))
        );
      }
      function j(e) {
        var t = P(e) ? re.call(e) : '';
      ...
      function E(e) {
        return 'symbol' == typeof e || (C(e) && re.call(e) == G);
      }
      function x(e) {
        return null == e ? '' : d(e);
      }
      ...
      function A(e, t, r) {
        ...
        var v = t.variable;
        v || (d = 'with (obj) {\n' + d + '\n}\n'),
          (d = (i ? d.replace(I, '') : d).replace(U, '$1').replace(R, '$1;')),
          (d =
            'function(' +
            (v || 'obj') +
            ') {\n' +
