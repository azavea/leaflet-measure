!(function(e) {
                  ...
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === w && (M = 0), i = 0; i < u[n].length; i++) {
                      for (s = 0; s < u[n][i].length - f; s++) {
                        if (!1 === t(u[n][i][s], p, v, b, M)) return !1;
                        p++;
                      }
                      M++;
                    }
  ...
  function(e, t, r) {
    (function(t) {
      ...
      function M(e) {
        return L(e) && te.call(e, 'callee') && (!ne.call(e, 'callee') || re.call(e) == F);
      }
      function w(e) {
      ...
      function j(e) {
        return (
          !!E(e) && (re.call(e) == z || ('string' == typeof e.message && 'string' == typeof e.name))
        );
      }
      function k(e) {
        var t = P(e) ? re.call(e) : '';
      ...
      function A(e, t, r) {
        ...
        var v = t.variable;
        v || (d = 'with (obj) {\n' + d + '\n}\n'),
          (d = (i ? d.replace(V, '') : d).replace(G, '$1').replace(H, '$1;')),
          (d =
            'function(' +
            (v || 'obj') +
            ') {\n' +
