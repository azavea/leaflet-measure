            ...
            if (null !== (a = h ? c.geometries[_] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== w && 'MultiPolygon' !== w) ? 0 : 1), w)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, d, v, b, M)) return !1;
                  d++, b++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < u.length; n++) {
                    if (!1 === t(u[n], d, v, b, M)) return !1;
                    d++, 'MultiPoint' === w && b++;
                  }
                  'LineString' === w && b++;
                  break;
                  ...
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === w && (M = 0), i = 0; i < u[n].length; i++) {
                      for (s = 0; s < u[n][i].length - f; s++) {
                        if (!1 === t(u[n][i][s], d, v, b, M)) return !1;
                        d++;
                      }
                      M++;
                    }
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      initialize: function(e) {
        ...
        var t = this.options,
          r = t.activeColor,
          o = t.completedColor;
        (this._symbols = new d.default({ activeColor: r, completedColor: o })),
    ...
    (function(t) {
      ...
      function l(e, t) {
        var r = ue(e) || M(e) ? i(e.length, String) : [],
          o = r.length,
          n = !!o;
        for (var s in e) (!t && !te.call(e, s)) || (n && ('length' == s || y(s, o))) || r.push(s);
        return r;
      }
      function u(e, t, r, o) {
      ...
      function g(e, t, r) {
        if (!O(r)) return !1;
        var o = typeof t;
        return !!('number' == o ? w(r) && y(t, r.length) : 'string' == o && t in r) && b(r[t], e);
      }
      function v(e) {
      ...
      function E(e) {
        return 'symbol' == typeof e || (C(e) && re.call(e) == V);
      }
      function x(e) {
        return null == e ? '' : p(e);
      }
      ...
      function A(e, t, r) {
        ...
        r && g(e, t, r) && (t = void 0), (e = x(e)), (t = ce({}, t, o, u));
        var n,
          i,
        ...
        var v = t.variable;
        v || (p = 'with (obj) {\n' + p + '\n}\n'),
          (p = (i ? p.replace(I, '') : p).replace(G, '$1').replace(H, '$1;')),
          (p =
            'function(' +
            (v || 'obj') +
            ') {\n' +
          ...
          return d(function(t, r) {
            ...
            for (
              i = e.length > 3 && 'function' == typeof i ? (n--, i) : void 0,
                s && g(r[0], r[1], s) && ((i = n < 3 ? void 0 : i), (n = 1)),
                t = Object(t);
              ++o < n;
