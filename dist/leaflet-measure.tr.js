!(function(e) {
      ...
      if (null !== e)
        for (
          ...
          for (var _ = 0; _ < l; _++) {
            var b = 0,
              M = 0;
            if (null !== (a = h ? c.geometries[_] : c)) {
              u = a.coordinates;
              var k = a.type;
              switch (((f = !r || ('Polygon' !== k && 'MultiPolygon' !== k) ? 0 : 1), k)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, p, v, b, M)) return !1;
                  p++, b++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (o = 0; o < u.length; o++) {
                    if (!1 === t(u[o], p, v, b, M)) return !1;
                    p++, 'MultiPoint' === k && b++;
                  }
                  'LineString' === k && b++;
                  break;
                ...
                case 'MultiLineString':
                  for (o = 0; o < u.length; o++) {
                    for (i = 0; i < u[o].length - f; i++) {
                      if (!1 === t(u[o][i], p, v, b, M)) return !1;
                      p++;
                    }
                    'MultiLineString' === k && b++, 'Polygon' === k && M++;
                  }
                  'Polygon' === k && b++;
                  break;
                case 'MultiPolygon':
                  for (o = 0; o < u.length; o++) {
                    for ('MultiPolygon' === k && (M = 0), i = 0; i < u[o].length; i++) {
                      for (s = 0; s < u[o][i].length - f; s++) {
                        if (!1 === t(u[o][i][s], p, v, b, M)) return !1;
                        p++;
                      }
                      M++;
                    }
  ...
  function(e, t, r) {
    ...
    var o = r(7),
      ...
      _ = (0, i.default)(m.pointPopupTemplate, y),
  ...
  function(e, t, r) {
    (function(t) {
      ...
      function g(e, t, r) {
        if (!P(r)) return !1;
        var n = typeof t;
        return !!('number' == n ? k(r) && y(t, r.length) : 'string' == n && t in r) && b(r[t], e);
      }
      function v(e) {
      ...
      function M(e) {
        return w(e) && te.call(e, 'callee') && (!oe.call(e, 'callee') || re.call(e) == q);
      }
      function k(e) {
        return null != e && O(e.length) && !j(e);
      }
      function w(e) {
        return E(e) && k(e);
      }
      function L(e) {
        return (
          !!E(e) && (re.call(e) == N || ('string' == typeof e.message && 'string' == typeof e.name))
        );
      }
      function j(e) {
        var t = P(e) ? re.call(e) : '';
      ...
      function A(e, t, r) {
        ...
        var v = t.variable;
        v || (d = 'with (obj) {\n' + d + '\n}\n'),
          (d = (i ? d.replace(G, '') : d).replace(V, '$1').replace(H, '$1;')),
          (d =
            'function(' +
            (v || 'obj') +
            ') {\n' +
            ...
            'return __p\n}');
        var _ = he(function() {
          return Function(c, y + 'return ' + d).apply(void 0, h);
        });
        if (((_.source = d), L(_))) throw _;
        return _;
      }
      var T = r(2),
        $ = r(8),
  ...
  function(e, t, r) {
    (function(t) {
      ...
      function a(e) {
        return (e = s(e)), e && f.test(e) ? e.replace(h, _) : e;
      }
      var l = r(2),
        u = 1 / 0,
        c = '[object Symbol]',
        ...
        M = b.toString,
        k = v.Symbol,
        w = k ? k.prototype : void 0,
        L = w ? w.toString : void 0,
        j = { escape: p, evaluate: d, interpolate: l, variable: '', imports: { _: { escape: a } } };
      e.exports = j;
    }.call(t, r(1)));
  },
  function(e, t, r) {
