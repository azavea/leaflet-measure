!(function(e) {
            ...
            if (null !== (a = h ? c.geometries[v] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== M && 'MultiPolygon' !== M) ? 0 : 1), M)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, p, _, b, w)) return !1;
                  p++, b++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < u.length; n++) {
                    if (!1 === t(u[n], p, _, b, w)) return !1;
                    p++, 'MultiPoint' === M && b++;
                  }
                  'LineString' === M && b++;
                  break;
                ...
                case 'MultiLineString':
                  for (n = 0; n < u.length; n++) {
                    for (i = 0; i < u[n].length - f; i++) {
                      if (!1 === t(u[n][i], p, _, b, w)) return !1;
                      p++;
                    }
                    'MultiLineString' === M && b++, 'Polygon' === M && w++;
                  }
                  'Polygon' === M && b++;
                  break;
                case 'MultiPolygon':
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === M && (w = 0), i = 0; i < u[n].length; i++) {
                      for (s = 0; s < u[n][i].length - f; s++) {
                        if (!1 === t(u[n][i][s], p, _, b, w)) return !1;
                        p++;
                      }
                      w++;
                    }
  ...
  function(e, t, r) {
    ...
    var n = r(7),
      ...
      w = (0, i.default)(m.areaPopupTemplate, g);
          ...
          1 === e.length
            ...
            : 2 === e.length
              ...
              : ((t = L.polygon(e, this._symbols.getSymbol('resultArea'))),
                (r = w({ model: L.extend({}, o, this._getMeasurementDisplayStrings(o)) })));
  ...
  function(e, t, r) {
    (function(t) {
      ...
      function l(e, t) {
        var r = ue(e) || w(e) ? i(e.length, String) : [],
          o = r.length,
          n = !!o;
      ...
      function y(e, t, r) {
        if (!O(r)) return !1;
        var o = typeof t;
        return !!('number' == o ? M(r) && g(t, r.length) : 'string' == o && t in r) && b(r[t], e);
      }
      function _(e) {
      ...
      function w(e) {
        return k(e) && te.call(e, 'callee') && (!ne.call(e, 'callee') || re.call(e) == F);
      }
      function M(e) {
        return null != e && P(e.length) && !j(e);
      }
      function k(e) {
        return E(e) && M(e);
      }
  ...
  function(e, t, r) {
    (function(t) {
      ...
      function i(e) {
        return 'symbol' == typeof e || (n(e) && w.call(e) == c);
      }
      function s(e) {
        return null == e ? '' : o(e);
      }
