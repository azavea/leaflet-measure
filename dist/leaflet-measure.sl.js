!(function(e) {
              ...
              switch (((f = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                ...
                case 'MultiLineString':
                  for (n = 0; n < u.length; n++) {
                    ...
                    'MultiLineString' === j && b++, 'Polygon' === j && M++;
                  }
                  'Polygon' === j && b++;
                  break;
                case 'MultiPolygon':
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === j && (M = 0), i = 0; i < u[n].length; i++) {
  ...
  function(e, t, r) {
    ...
    var n = r(7),
      ...
      _ = (0, i.default)(m.pointPopupTemplate, g),
  ...
  function(e, t, r) {
    (function(t) {
      ...
      function y(e, t, r) {
        if (!P(r)) return !1;
        var o = typeof t;
        return !!('number' == o ? j(r) && g(t, r.length) : 'string' == o && t in r) && b(r[t], e);
      }
      function v(e) {
      ...
      function M(e) {
        return w(e) && te.call(e, 'callee') && (!ne.call(e, 'callee') || re.call(e) == N);
      }
      function j(e) {
      ...
      function L(e) {
        return (
          !!C(e) && (re.call(e) == F || ('string' == typeof e.message && 'string' == typeof e.name))
        );
      }
      function k(e) {
        var t = P(e) ? re.call(e) : '';
      ...
      function A(e, t, r) {
        ...
        var v = t.variable;
        v || (p = 'with (obj) {\n' + p + '\n}\n'),
          (p = (i ? p.replace(G, '') : p).replace(V, '$1').replace(R, '$1;')),
          (p =
            'function(' +
            (v || 'obj') +
            ') {\n' +
